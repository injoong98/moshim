	...
	<header class="main-header style-two">
		...
		<div class="sticky-header">
			<div class="container clearfix">
				<figure class="logo-box"><a href="index.html"><img src="../assets/moshim/images/small-logo.png" alt=""></a></figure>
				<div class="menu-area">
					<nav class="main-menu navbar-expand-lg">
						<div class="navbar-header">
							<!-- Toggle Button -->
			...
			<div class="container">
				<div class="inner-container clearfix">
					...
					<div class="right-content pull-right">
						<figure class="footer-logo"><a href="index.html"><img src="../assets/moshim/images/footer-logo.png" alt=""></a></figure>
