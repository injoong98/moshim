                       ...
                       <div class="inner-box">
                           ...
                           <div class="lower-content">
                               ...
                               <ul class="social-list" style="font-size:20px">
                                   ...
                                   <li><a class="play_button" onclick="openWin_cd('1')" target="_blank" style="color:white; font-size:20px">가사</a></li>
                               </ul>
                           </div>
                       </div>
                   </div>
                       ...
                       <div class="inner-box">
                           ...
                           <div class="lower-content">
                               ...
                               <ul class="social-list">
                                   ...
                                   <li><a class="play_button" onclick="openWin_cd('2')" target="_blank" style="font-size:20px">가사</a></li>
                               </ul>
                           </div>
                       </div>
                   </div>
                       ...
                       <div class="inner-box">
                           ...
                           <div class="lower-content">
                               ...
                               <ul class="social-list">
                                   ...
                                   <li><a class="play_button" onclick="openWin_cd('3')" target="_blank" style="font-size:20px">가사</a></li>
                               </ul>
                           </div>
                       </div>
                   </div>
                       ...
                       <div class="inner-box">
                           ...
                           <div class="lower-content">
                               ...
                               <ul class="social-list">
                                   ...
                                   <li><a class="play_button" onclick="openWin_cd('4')" target="_blank" style="font-size:20px">가사</a></li>
                               </ul>
                           </div>
                       </div>
                   </div>
                       ...
                       <div class="inner-box">
                           ...
                           <div class="lower-content">
                               ...
                               <ul class="social-list">
                                   ...
                                   <li><a class="play_button" onclick="openWin_cd('5')" target="_blank" style="font-size:20px">가사</a></li>
                               </ul>
                           </div>
                       </div>
                   </div>
                       ...
                       <div class="inner-box">
                           ...
                           <div class="lower-content">
                               ...
                               <ul class="social-list">
                                   ...
                                   <li><a class="play_button" onclick="openWin_cd('7')" target="_blank" style="font-size:20px">가사</a></li>
                               </ul>
                           </div>
                       </div>
                   </div>
                       ...
                       <div class="inner-box">
                           ...
                           <div class="lower-content">
                               ...
                               <ul class="social-list">
                                   ...
                                   <li><a class="play_button" onclick="openWin_cd('8')" target="_blank" style="font-size:20px">가사</a></li>
                               </ul>
                           </div>
                       </div>
                   </div>
                       ...
                       <div class="inner-box">
                           ...
                           <div class="lower-content">
                               ...
                               <ul class="social-list">
                                   ...
                                   <li><a class="play_button" onclick="openWin_cd('9')" target="_blank" style="font-size:20px">가사</a></li>
                               </ul>
                           </div>
                       </div>
                   </div>
                       ...
                       <div class="inner-box">
                           ...
                           <div class="lower-content">
                               ...
                               <ul class="social-list">
                                   ...
                                   <li><a class="play_button" onclick="openWin_cd('10')" target="_blank" style="font-size:20px">가사</a></li>
                               </ul>
                           </div>
                       </div>
                   </div>
                       ...
                       <div class="inner-box">
                           ...
                           <div class="lower-content">
                               ...
                               <ul class="social-list">
                                   ...
                                   <li><a class="play_button" onclick="openWin_cd('11')" target="_blank" style="font-size:20px">가사</a></li>
                               </ul>
                           </div>
                       </div>
                   </div>
                       ...
                       <div class="inner-box">
                           ...
                           <div class="lower-content">
                               ...
                               <ul class="social-list">
                                   ...
                                   <li><a class="play_button" onclick="openWin_cd('12')" target="_blank" style="font-size:20px">가사</a></li>
                               </ul>
                           </div>
                       </div>
                   </div>
