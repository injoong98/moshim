           ...
           <div class="row">
               <div class="col-lg-3 col-md-6 col-sm-12 block-column">
                   <div class="inner-block wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                       ...
                       <div class="lower-content">
                           <h6>세트</h6>
                           <div class="link-btn" style="display:none"><a target="_blank" onclick="javascript:openWin_books(1);"><i class="flaticon-next"></i></a></div>
               ...
               <div class="col-lg-3 col-md-6 col-sm-12 block-column play_button">
                   <div class="inner-block wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                       ...
                       <div class="lower-content">
                           <h6>제5권</h6>
                           <div class="link-btn"><a target="_blank" onclick="javascript:openWin_books(5);" style="background-color:#8DD554"><i class="flaticon-next"></i></a></div>
