   ...
   <section class="classes-section classes-page-section sec-pad">
       ...
       <div class="sec-title text-center">
                <!-- PC -->
               <h5 class="books_title"><?php echo $this->lang->line('main_title_3') ?></h5>
               <h1 class="books_title"><?php echo $this->lang->line('main_subtitle_3') ?></h1>
                <!-- 모바일 -->
                <h5 class="soundbook_title_mobile line-three"><?php echo $this->lang->line('main_title_mobile_3') ?></h5>
                <h3 class="books_title_mobile"><?php echo $this->lang->line('main_subtitle_mobile_3') ?></h3>
           </div>
           <div class="row">
