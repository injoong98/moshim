                   ...
                   <div class="teachers-block-one wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                       <div class="inner-box">
                           <div class="image-holder">
                               <figure class="image-box"><a onclick="javascript:openWin('05');"><img src="<?php echo moshim_url('momo') ?>/assets/moshim/images/cd/07.jpg" alt=""></a></figure>
                           </div>
   ...
   <script language="javascript" type="text/javascript">
       function openWin(num) {
           window.open(`http://moshim.co.kr/pages/soundbookpage/${num}`, "오디오북 자세히 보기", "width=1020, height=628, toolbar=no, menubar=no, scrollbars=no, resizable=no");
       }
   </script>