                       ...
                       <div class="inner-box">
                           ...
                           <div class="lower-content">
                               ...
                               <!-- <ul class="social-list">
                                 ...
                                 <li><a target="_blank" onclick ="openWin_soundbooks()"><i class="fab fa-twitter"></i></a></li>
                                 <li><a target="_blank" onclick ="openWin_soundbooks()"><i class="fab fa-google-plus-g"></i></a></li>
                                 <li><a target="_blank" onclick ="openWin_soundbooks()"><i class="fab fa-pinterest-p"></i></a></li>
                             </ul> -->
                           </div>
                       </div>
                   </div>
               ...
               <div class="col-xl-4 col-lg-6 col-md-12 block-column">
                   <div class="teachers-block-one wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                       <div class="inner-box">
                           ...
                           <div class="lower-content">
                               <h3 style="font-size: 0.9em;"><a target="_blank" onclick="openWin_soundbooks('12')">12. 새로운 세상 우리 함께해요</a></h3>
                               <!-- <span class="designation">Teacher</span> -->
                               <!-- <ul class="social-list">
                                 <li><a target="_blank" onclick ="openWin_soundbooks()"><i class="fab fa-facebook-f"></i></a></li>
                                 <li><a target="_blank" onclick ="openWin_soundbooks()"><i class="fab fa-twitter"></i></a></li>
