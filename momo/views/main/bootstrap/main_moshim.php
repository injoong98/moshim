    ...
    <section class="main-slider">
        <div class="main-slider-carousel owl-carousel owl-theme nav-style-one">
            <div class="slide" style="background-image:url(../assests/moshim/images/main-slider/main-1.jpg)">
                <!-- <div class="container">
            ...
            <div class="slide" style="background-image:url(../assests/moshim/images/main-slider/main-2.jpg)">
                <!-- <div class="container">
                    <div class="content-box">
                        <h3>Best Choise</h3>
                        <h1>Make Your Children's Life Special</h1>
            ...
            <div class="slide" style="background-image:url(../assests/moshim/images/main-slider/main-3.jpg)">
                <!-- <div class="container">
                    <div class="content-box">
                        <h3>Best Choise</h3>
                        <h1>Make Your Children's Life Special</h1>
            ...
            <div class="slide" style="background-image:url(../assests/moshim/images/main-slider/main-4.jpg)">
                <!-- <div class="container">
                    <div class="content-box">
                        <h3>Best Choise</h3>
                        <h1>Make Your Children's Life Special</h1>
            ...
            <div class="slide" style="background-image:url(../assests/moshim/images/main-slider/main-5.jpg)">
                <!-- <div class="container">
                    <div class="content-box">
                        <h3>Best Choise</h3>
                        <h1>Make Your Children's Life Special</h1>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div class="image-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <figure class="image image-1"><img src="../assests/moshim/images/resource/about-1.jpg" alt=""></figure>
                        <figure class="image image-2"><img src="../assests/moshim/images/resource/about-2.jpg" alt=""></figure>
                    </div>
                </div>
    ...
    <!-- 쇼핑몰 시작 -->
    <section class="service-section sec-pad" style="background-image: url(../assests/moshim/images/background/service-bg.jpg);">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><a href="blog-details.html"><img src="../assests/moshim/images/resource/news-1.jpg" alt=""></a></figure>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><a href="blog-details.html"><img src="../assests/moshim/images/resource/news-2.jpg" alt=""></a></figure>
                            <div class="lower-content">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><a href="blog-details.html"><img src="../assests/moshim/images/resource/news-3.jpg" alt=""></a></figure>
                            <div class="lower-content">
            ...
            <div class="row">
                    ...
                    <div class="teachers-block-one wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <div class="image-holder">
                                <figure class="image-box"><a href="#"><img src="../assests/moshim/images/resource/teacher-1.png" alt=""></a></figure>
                            </div>
                            <div class="lower-content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-12 block-column">
                    <div class="teachers-block-one wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <div class="image-holder">
                                <figure class="image-box"><a href="#"><img src="../assests/moshim/images/resource/teacher-2.png" alt=""></a></figure>
                            </div>
                            <div class="lower-content">
                ...
                <div class="col-xl-4 col-lg-6 col-md-12 block-column">
                    <div class="teachers-block-one wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <div class="image-holder">
                                <figure class="image-box"><a href="#"><img src="../assests/moshim/images/resource/teacher-3.png" alt=""></a></figure>
                            </div>
                            <div class="lower-content">
