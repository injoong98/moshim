...
.sticker-img{
    ...
    <!-- breadcrumb part end -->
    <!-- fetures part here -->
    <section class="fetures_part section_padding" style="background-color: #ffffff;padding-bottom:0px">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-7">
        ...
        <div class="feature_animation_1">
            <div data-parallax='{"x": 2, "y": 120, "rotateZ":0}'><img src="/assets/malgeunmul/img/animation_shape/program_list_shape_01.png" alt="#"></div>
        </div>
        <div class="feature_animation_2">
            <div data-parallax='{"x": 10, "y": 100, "rotateZ":0}'><img src="/assets/malgeunmul/img/animation_shape/program_list_shape_02.png" alt="#"></div>
        </div>
        <div class="feature_animation_3">
            <div data-parallax='{"x": 30, "y": 110, "rotateZ":0}'><img src="/assets/malgeunmul/img/animation_shape/program_list_shape_03.png" alt="#"></div>
        </div>
    </section>
    <!-- fetures part end -->
    ...
    <!-- <section class="event_section event_details pt-5">
        ...
        <div class="about_page_animation_1">
            <div data-parallax='{"x": 2, "y": 70, "rotateZ":0}'><img src="/assets/malgeunmul/img/icon/icon_7.png" alt="#"></div>
        </div>
        <div class="about_page_animation_2">
            <div data-parallax='{"x": 10, "y": 80, "rotateZ":0}'><img src="/assets/malgeunmul/img/icon/event_6.png" alt="#"></div>
        </div>
        <div class="about_page_animation_3">
            <div data-parallax='{"x": 30, "y": 60, "rotateZ":0}'><img src="/assets/malgeunmul/img/icon/banner_two_2.png" alt="#"></div>
        </div>
    ...
    <section class="team_section single_page_team section_padding">
        <div class="container">
            <h4 class="kid_title wow fadeInLeft mb-0" data-wow-delay=".4s"> <span class="Cafe24Ssurround title_overlay_effect">티셔츠</span>
                <!-- <span> 25,000원</span> -->
            </h4>
            ...
            <h4 class="kid_title wow fadeInLeft mb-0" data-wow-delay=".4s"> <span class="Cafe24Ssurround title_overlay_effect">마스크</span>
                <!-- <span> 3,000원</span> -->
            </h4>
            <div class="row col-lg-12">
                <div class="good col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay=".5s">
                    <div class="single_team_section mt-3 mb-5">
                        ...
                        <h4> <a class ="product-title"href="/assets/malgeunmul/img/goods/prod/mask-01.jpg">효정 마스크</a></h4>
                        <h4 class="price"><a class ="product-title" href="/assets/malgeunmul/img/goods/prod/t-shirt-01.jpg">3,000원</a></h4>
                    </div>
                </div>
                <div class="good col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay=".5s">
                    <div class="single_team_section mt-3 mb-5">
                        ...
                        <h4> <a class ="product-title"href="/assets/malgeunmul/img/goods/prod/mask-02.jpg">효지 마스크</a></h4>
                        <h4 class="price"><a class ="product-title" href="/assets/malgeunmul/img/goods/prod/t-shirt-01.jpg">3,000원</a></h4>
                    </div>
                </div>
                <div class="good col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay=".5s">
                    <div class="single_team_section mt-3 mb-5">
                        ...
                        <h4> <a class ="product-title"href="/assets/malgeunmul/img/goods/prod/mask-03.jpg">효리 마스크</a></h4>
                        <h4 class="price"><a class ="product-title" href="/assets/malgeunmul/img/goods/prod/t-shirt-01.jpg">3,000원</a></h4>
                    </div>
                </div>
                <div class="good col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay=".5s">
                    <div class="single_team_section mt-3 mb-5">
                        ...
                        <h4> <a class ="product-title"href="/assets/malgeunmul/img/goods/prod/mask-04.jpg">효몽 마스크</a></h4>
                        <h4 class="price"><a class ="product-title" href="/assets/malgeunmul/img/goods/prod/t-shirt-01.jpg">3,000원</a></h4>
                    </div>
                </div>
            </div>
            <h4 class="kid_title wow fadeInLeft mb-0" data-wow-delay=".4s"> <span class="Cafe24Ssurround title_overlay_effect">마스크 스트랩</span>
                <!-- <span> 2,500원</span> -->
            </h4>
            <div class="row col-lg-12">
                <div class="good col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay=".5s">
            ...
            <h4 class="kid_title wow fadeInLeft mb-0" data-wow-delay=".4s"> <span class="Cafe24Ssurround title_overlay_effect">인형(대)</span>
                <!-- <span> 30,000원</span> -->
            </h4>
            <div class="row col-lg-12">
                <div class="good col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay=".5s">
            ...
            <h4 class="kid_title wow fadeInLeft mb-0" data-wow-delay=".4s"> <span class="Cafe24Ssurround title_overlay_effect">쿠션</span>
                <!-- <span> 24,000원</span> -->
            </h4>
            <div class="row col-lg-12">
                <div class="good col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay=".5s">
            ...
            <h4 class="kid_title wow fadeInLeft mb-0" data-wow-delay=".4s"> <span class="Cafe24Ssurround title_overlay_effect">스티커</span>
                <!-- <span> 1,500원</span> -->
            </h4>
            <div class="row col-lg-12">
                <div class="good col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay=".5s">
        ...
        <div class="team_animation_1">
            <div data-parallax='{"x": 2, "y": 120, "rotateZ":0}'><img src="<?php echo trim(site_url(), '/'); ?>/assets/malgeunmul/img/animation_shape/program_list_shape_01.png" alt="#"></div>
        </div>
        <div class="team_animation_2">
            <div data-parallax='{"x": 10, "y": 100, "rotateZ":0}'><img src="<?php echo trim(site_url(), '/'); ?>/assets/malgeunmul/img/animation_shape/program_list_shape_02.png" alt="#"></div>
        </div>
