 ...
 <section class="banner_part bannerslider owl-carousel">
        <div class="single_banner_part bg_1">
            ...
            <div class="banner_animation_1">
                <div data-parallax='{"x": 20, "y": 200, "rotateZ":0}'>
                    <img src="../assets/malgeunmul/img/icon/banner_1.png" alt="#">
                </div>
            </div>
            <div class="banner_animation_2">
                <div data-parallax='{"x": 15, "y": 150, "rotateZ":0}'>
                    <img src="../assets/malgeunmul/img/icon/banner_2.png" alt="#">
                </div>
            </div>
            <div class="banner_animation_3">
                <div data-parallax='{"x": 0, "y": 200, "rotateZ":0}'>
                    <img src="../assets/malgeunmul/img/icon/banner_3.png" alt="#">
                </div>
            </div>
            <div class="banner_animation_4">
                <div data-parallax='{"x": 10, "y": 150, "rotateZ":0}'>
                    <img src="../assets/malgeunmul/img/icon/banner_4.png" alt="#">
                </div>
            </div>
        </div>
        <div class="single_banner_part bg_1">
    ...
    <section class="services_part wave_shape_bg sec_padding">
            ...
            <div class="services_shape_animation_1">
                <div data-parallax='{"x": 2, "y": 80, "rotateZ":0}'>
                    <img src="../assets/malgeunmul/img/animation_shape/feature_shape_01.png" alt="#">
                </div>
            </div>
            <div class="services_shape_animation_2">
                <div data-parallax='{"x": 15, "y": 100, "rotateZ":0}'>
                    <img src="../assets/malgeunmul/img/animation_shape/feature_shape_02.png" alt="#">
                </div>
            </div>
            <div class="services_shape_animation_3">
                <div data-parallax='{"x": 0, "y": 90, "rotateZ":0}'>
                    <img src="../assets/malgeunmul/img/animation_shape/feature_shape_03.png" alt="#">
                </div>
            </div>
            <div class="services_shape_animation_4">
                <div data-parallax='{"x": 10, "y": 120, "rotateZ":0}'>
                    <img src="../assets/malgeunmul/img/animation_shape/feature_shape_04.png" alt="#">
                </div>
            </div>
        </section>
        <!-- services part end -->
        ...
        <section class="about_section section_padding s4_about_section">
                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-lg-6 order-1 order-lg-2">
                        <div class="img_section">
                            <img src="../assets/malgeunmul/img/about_img_shape_2.png" alt="#" class="about_img_7"
                                data-parallax='{"x": 0, "y": -50, "rotateZ":0}'>
                            <img src="../assets/malgeunmul/img/about_img_7.png" alt="#" class="about_img_6 img-fluid">
                            <img src="../assets/malgeunmul/img/about_img_shape_1.png" alt="#" class="about_img_5"
                                data-parallax='{"x": 0, "y": 50, "rotateZ":0}'>
                        </div>
                    </div>
                </div>
            ...
            <div class="about_page_animation_1">
                <div data-parallax='{"x": 2, "y": 70, "rotateZ":0}'><img src="../assets/malgeunmul/img/icon/icon_5.png" alt="#"></div>
            </div>
            <div class="about_page_animation_2">
                <div data-parallax='{"x": 10, "y": 80, "rotateZ":0}'><img src="../assets/malgeunmul/img/icon/icon_6.png" alt="#"></div>
            </div>
            <div class="about_page_animation_3">
                <div data-parallax='{"x": 30, "y": 60, "rotateZ":0}'><img src="../assets/malgeunmul/img/icon/icon_7.png" alt="#"></div>
            </div>
            <div class="about_page_animation_4">
                <div data-parallax='{"x": 30, "y": -50, "rotateZ":0}'><img src="../assets/malgeunmul/img/icon/icon_8.png" alt="#"></div>
            </div>
        </section>
        ...
        <section class="get_start_part section_padding section_bg">
                ...
                <div class="row justify-content-between align-items-center">
                    <div class="col-lg-7 wow fadeInUp" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                        <div class="video_section">
                            <img src="../assets/malgeunmul/img/video_section_bg.png" alt="#" class="img-fluid">
            ...
            <div class="get_start_animation_1"><div data-parallax='{"x": 2, "y": 120, "rotateZ":0}'><img src="../assets/malgeunmul/img/icon/feature_1.png" alt="#"></div></div>
            <div class="get_start_animation_3"><div data-parallax='{"x": 30, "y": 110, "rotateZ":0}'><img src="../assets/malgeunmul/img/icon/feature_3.png" alt="#"></div></div>
            <div class="get_start_animation_6"><div data-parallax='{"x": 15, "y": 115, "rotateZ":0}'><img src="../assets/malgeunmul/img/icon/feature_6.png" alt="#"></div></div>
            <div class="get_start_animation_9"><div data-parallax='{"x": 20, "y": 120, "rotateZ":0}'><img src="../assets/malgeunmul/img/icon/feature_13.png" alt="#"></div></div>
            <div class="get_start_animation_11"><div data-parallax='{"x": 15, "y": 115, "rotateZ":0}'><img src="../assets/malgeunmul/img/icon/feature_12.png" alt="#"></div></div>
            <div class="get_start_animation_12"><div data-parallax='{"x": 20, "y": 40, "rotateZ":0}'><img src="../assets/malgeunmul/img/icon/feature_7.png" alt="#"></div></div>
        </section>
        <!-- get start part end -->
        ...
        <section class="breadcrumb_part parallax_bg">
                ...
                <div class="breadcrumb_animation_4">
                    <div data-parallax='{"x": 30, "y": 250, "rotateZ":0}'>
                        <img src="../assets/malgeunmul/img/icon/banner_icon/animated_banner_4.png" alt="#">
                    </div>
                </div>
                <div class="breadcrumb_animation_5">
                    <div data-parallax='{"x": 20, "y": 150, "rotateZ": 180}'>
                        <img src="../assets/malgeunmul/img/icon/banner_icon/animated_banner_5.png" alt="#">
                    </div>
                </div>
                <div class="breadcrumb_animation_7">
                    <div data-parallax='{"x": 100, "y": 250, "rotateZ":0}'>
                        <img src="../assets/malgeunmul/img/icon/banner_icon/animated_banner_15.png" alt="#">
                    </div>
                </div>
                <div class="breadcrumb_animation_10">
                    <div data-parallax='{"x": 15, "y": 150, "rotateZ":0}'>
                        <img src="../assets/malgeunmul/img/icon/banner_icon/animated_banner_10.png" alt="#">
                    </div>
                </div>
                <div class="breadcrumb_animation_12">
                    <div data-parallax='{"x": 20, "y": 150, "rotateZ":180}'>
                        <img src="../assets/malgeunmul/img/icon/banner_icon/animated_banner_20.png" alt="#">
                    </div>
                </div>
                <div class="breadcrumb_animation_13">
                    <div data-parallax='{"x": 10, "y": 250, "rotateZ": 180}'>
                        <img src="../assets/malgeunmul/img/icon/banner_icon/animated_banner_21.png" alt="#">
                    </div>
                </div>
            </section>
            <!-- breadcrumb part end -->
            ...
            <section class="event_part section_padding section_bg_2">
                            ...
                            <div class="event_part_iner">
                                <div class="row justify-content-end">
                                    <div class="event_img wow fadeInLeft" data-wow-delay=".5s">
                                        <img src="../assets/malgeunmul/img/event_img.png" alt="#" class="img-fluid">
                                    </div>
                ...
                <div class="event_animation_1">
                    <div data-parallax='{"x": 2, "y": 120, "rotateZ":0}'><img src="../assets/malgeunmul/img/icon/event_1.png" alt="#"></div>
                </div>
                <div class="event_animation_2">
                    <div data-parallax='{"x": 10, "y": 100, "rotateZ":0}'><img src="../assets/malgeunmul/img/icon/event_2.png" alt="#"></div>
                </div>
                <div class="event_animation_3">
                    <div data-parallax='{"x": 30, "y": 110, "rotateZ":0}'><img src="../assets/malgeunmul/img/icon/event_3.png" alt="#"></div>
                </div>
            </section>
            <!-- services part end -->
            ...
            <section class="cta_part section_padding">
                ...
                <div class="breadcrumb_animation_1">
                    <div data-parallax='{"x": 30, "y": -20}'>
                        <img src="../assets/malgeunmul/img/cta_img_1.png" alt="#">
                    </div>
                </div>
                <div class="breadcrumb_animation_2">
                    <div data-parallax='{"x": 20, "y": -100}'>
                        <img src="../assets/malgeunmul/img/cta_img_2.png" alt="#">
                    </div>
                </div>
            </section>
            <!-- cta part end -->
            ...
            <section class="contact_part section_bg section_padding">
                ...
                <div class="contact_animation_1">
                    <div data-parallax='{"x": 30, "y": 100, "rotateZ":0}'>
                        <img src="../assets/malgeunmul/img/icon/cta_1.png" alt="#">
                    </div>
                </div>
                <div class="contact_animation_2">
                    <div data-parallax='{"x": 20, "y": 150, "rotateZ": 180}'>
                        <img src="../assets/malgeunmul/img/icon/contact_icon.png" alt="#">
                    </div>
                </div>
                <div class="contact_animation_3">
                    <div data-parallax='{"x": 100, "y": 250, "rotateZ":0}'>
                        <img src="../assets/malgeunmul/img/icon/banner_two_3.png" alt="#">
                    </div>
                </div>
                <div class="contact_animation_4">
                    <div data-parallax='{"x": 15, "y": 150, "rotateZ":0}'>
                        <img src="../assets/malgeunmul/img/icon/event_6.png" alt="#">
                    </div>
                </div>
                <div class="contact_animation_5">
                    <div data-parallax='{"x": 20, "y": 150, "rotateZ":180}'>
                        <img src="../assets/malgeunmul/img/icon/icon_8.png" alt="#">
                    </div>
                </div>
                <div class="contact_animation_6">
                    <div data-parallax='{"x": 10, "y": 250, "rotateZ": 180}'>
                        <img src="../assets/malgeunmul/img/icon/icon_7.png" alt="#">
                    </div>
                </div>
            </section>
            <!-- contact part end -->
